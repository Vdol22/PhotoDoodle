    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
                ...
                packed_noisy_model_input_ = FluxPipeline._pack_latents(
                    noisy_model_input,
                ...
                packed_noisy_model_input = torch.concat([packed_noisy_model_input_, packed_cond_model_input], dim=-2)
                ...
                model_pred = model_pred[:, :packed_noisy_model_input_.shape[1], :]
            ...
            if accelerator.is_main_process:
                if args.validation_prompt is not None and global_step % args.validation_steps == 0:
                    ...
                    condition_image = Image.open(args.validation_image)
                    target_size = 768
                    condition_image = condition_image.resize((target_size, target_size), Image.LANCZOS)
